 ...
 * Date : 29-Sep-2021
 * Description : Start file of a Self creation portal service
 */
...
app.all("*", (req, res, next) => {
  logger.info("***SelfCreationPortal Service Request Log***", {
    request: {
      requestType: `Request Type ${req.method} for ${
        req.url
      } on ${new Date()} from ${req.headers["user-agent"]}`,

...
module.exports = class PermissionsHelper {
  ...
  static async update(id, bodyData) {
    try {
      ...
      const updatedPermission = await permissionsQueries.updatePermissions(
        filter,
        bodyData
      );
  ...
  static async delete(id) {
    try {
      ...
      const deletePermission = await permissionsQueries.deletePermissionById(
        id
      );
      if (!deletePermission) {
        return responses.failureResponse({
  ...
  static async list(page, limit, search) {
    try {
      ...
      const permissions = await permissionsQueries.findAllPermissions(
        filter,
        attributes,
        options
      );

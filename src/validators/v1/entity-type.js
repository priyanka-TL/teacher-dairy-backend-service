...
module.exports = {
  create: (req) => {
    ...
    req
      .checkBody("model_names.*")
      .isIn(["User"])
      .withMessage("model_names must be User");

    req
      .checkBody("allow_filtering")
      .optional()
      .isEmpty()
      .withMessage("allow_filtering is not allowed in create");
  },
  ...
  update: (req) => {
    ...
    req
      ...
      .withMessage(
        "model_names must be in Session,MentorExtension,UserExtension"
      );
  },
